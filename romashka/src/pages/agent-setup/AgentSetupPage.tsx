          ...
          <div className="space-y-6">
            ...
            <div className="max-w-4xl mx-auto">
              <div className="bg-gray-50 rounded-lg p-6 mb-6">
                ...
                {/* Beautiful Widget Preview - Matches Production Design */}
                <div className="relative h-[600px] bg-gray-100 rounded-xl border shadow-lg p-6 flex items-end justify-end">
                  {/* Beautiful gradient background */}
                  <div className="absolute inset-0 bg-gradient-to-br from-pink-50 via-purple-50 to-blue-50 -z-10 rounded-xl"></div>
                  <div className="absolute top-6 left-6 text-sm text-gray-600">
                    <div className="bg-white/80 backdrop-blur-sm rounded-lg px-3 py-2 shadow-sm border border-white/20">
                      <div className="flex items-center space-x-2">
                        <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse"></div>
                        <span className="font-medium">Preview: Your website with ROMASHKA widget</span>
                      </div>
                    </div>
                  </div>

                  {/* Beautiful Chat Widget Toggle Button - Matches Production */}
                  {!isWidgetOpen && (
                    <button
                      onClick={() => setIsWidgetOpen(true)}
                      className="w-16 h-16 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center relative group"
                      style={{ backgroundColor: '#ec4899' }}
                    >
                      {/* Unread message badge */}
                      <div className="absolute -top-2 -right-2 bg-red-500 text-white text-xs rounded-full w-7 h-7 flex items-center justify-center font-bold animate-bounce">
                        1
                      </div>
                  ...
                  {/* Beautiful Opened Widget - Larger Size */}
                  {isWidgetOpen && (
                    <div className="w-96 h-[500px] bg-white rounded-xl shadow-2xl border border-gray-200 overflow-hidden flex flex-col">
                      {/* Beautiful Widget Header - Matches Production Pink */}
                      <div className="text-white p-4 flex-shrink-0" style={{ background: 'linear-gradient(135deg, #ec4899 0%, #be185d 100%)' }}>
                        <div className="flex items-center justify-between">
                          <div className="flex items-center space-x-3">
                            ...
                            <div>
                              <h4 className="font-semibold text-base">Chat with {agentName || 'ROMASHKA'}</h4>
                              <div className="flex items-center space-x-1">
                                <div className="w-2 h-2 bg-green-400 rounded-full animate-pulse"></div>
                                <p className="text-xs text-pink-100">Online • 1 agent available</p>
                              </div>
                            </div>
                          </div>
                          <div className="flex items-center space-x-2">
                      ...
                      {/* Beautiful Messages Area */}
                      <div className="flex-1 p-5 space-y-4 bg-gradient-to-b from-gray-50 to-white overflow-y-auto min-h-0">
                          ...
                          <div key={message.id} className={`flex ${message.sender === 'user' ? 'justify-end' : 'justify-start'}`}>
                            <div className="max-w-sm">
                              ...
                              <p className={`text-xs mt-2 ${
                                message.sender === 'user' ? 'text-gray-400 text-right mr-1' : 'text-gray-400 ml-1'
                              }`}>
                          ...
                          <div className="flex justify-start">
                            <div className="bg-white border border-pink-100 rounded-2xl rounded-bl-sm px-4 py-3 shadow-sm">
                              <div className="flex space-x-1">
                                <div className="w-2 h-2 rounded-full animate-bounce" style={{ backgroundColor: '#ec4899' }}></div>
                                <div className="w-2 h-2 rounded-full animate-bounce" style={{ backgroundColor: '#ec4899', animationDelay: '0.1s' }}></div>
                                <div className="w-2 h-2 rounded-full animate-bounce" style={{ backgroundColor: '#ec4899', animationDelay: '0.2s' }}></div>
                              </div>
                            </div>
                          </div>
                        )}
                      ...
                      {/* Beautiful Input Area - Matches Production */}
                      <div className="border-t border-pink-100 p-4 bg-white flex-shrink-0">
                        <div className="flex items-center space-x-3">
                          ...
                          <div className="flex-1 relative">
                            <input
                              ...
                              className="w-full px-4 py-3 border border-gray-200 rounded-full text-sm focus:outline-none focus:ring-2 focus:border-pink-300 transition-all duration-200 bg-gray-50 focus:bg-white"
                          ...
                          <button 
                            ...
                            className="p-3 text-white rounded-full hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 flex-shrink-0"
                            style={{ 
