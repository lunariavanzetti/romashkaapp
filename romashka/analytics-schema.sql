...
-- Insert sample dashboard config (without user_id for now - will be set when user creates their first dashboard)
INSERT INTO dashboard_configs (name, is_default, layout, filters) VALUES
('Default Dashboard', true, 
 '{"widgets": [{"id": "kpi-1", "type": "kpi", "position": {"x": 0, "y": 0, "w": 3, "h": 2}, "config": {"title": "Active Conversations", "metric": "active_conversations"}}]}',
 '{"timeRange": "today", "channels": ["all"]}')
ON CONFLICT DO NOTHING; 